...
import { ADD_EXPENSE, DELETE_EXPENSE } from "@/graphql/expenseMutations";
    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="space-y-2">
        {!loading && expenses.length === 0 && (
          <p className="text-gray-400">No expenses yet. {isAdmin ? "Add one above!" : "Ask your admin to add expenses."}</p>
        )}
